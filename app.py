...
def logout():
    ...
    # IMPLEMENT THIS
    # On logout, it should flash a success message and redirect to the login page.s
    do_logout()
...
# Create a function that will show  the likes in the user
...
# Create a function for adding the likes
